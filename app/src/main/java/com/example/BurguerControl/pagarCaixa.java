...
public class pagarCaixa extends AppCompatActivity {
    FirebaseAuth autentica = FirebaseAuth.getInstance();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pagar_caixa);
    }
    ...
    public void sairSistema(View view) {
        ...
        msg.setNegativeButton("Não", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                Toast.makeText(pagarCaixa.this,"Ação cancelada",Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void voltar(View view){
        Intent intent = new Intent(this, selecionarPedido.class);
