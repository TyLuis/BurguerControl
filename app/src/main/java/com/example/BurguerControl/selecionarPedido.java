...
public class selecionarPedido extends AppCompatActivity {
    FirebaseAuth autentica = FirebaseAuth.getInstance();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_selecionar_pedido);
    }
    ...
    public void sairSistema(View view) {
        ...
        msg.setNegativeButton("Não", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                Toast.makeText(selecionarPedido.this,"Ação cancelada",Toast.LENGTH_LONG).show();
            }
        });
